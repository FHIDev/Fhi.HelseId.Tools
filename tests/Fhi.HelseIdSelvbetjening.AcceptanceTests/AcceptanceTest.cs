...
namespace Fhi.HelseId.ClientSecret.App.Tests.AcceptanceTests
{
    ...
    public class AcceptanceTest
    {
        ...
        public async Task GenerateKeys()
        {
            ...
            var argsGenerateKey = new[] { "generatekey", "--KeyPath", filePath, "--FileName", "test" };
